import{d as a,r as l,u as F,j as e,b as $,S as N,C as Q}from"./index-CKGOnOdZ.js";import{a as q}from"./quiz-4uUA3HIg.js";import{T as z}from"./TitlePage-gYm-nf-7.js";import{a as B,c as E,F as I}from"./formik.esm-8XN5jxYq.js";const M=a(B)`
  min-height: 200px;
`,T=a(E)`
  margin-right: 5px;
  max-width: 200px;
...
`,A=a.div`
  color: #e32636;
`,D=({questions:n,questionItem:s,isBackDisabled:m,isNextDisabled:r,isSubmitAction:u,currentIndex:d,handleClickBack:h,handleClickNext:p,time:f,quizId:g})=>{const[j,x]=l.useState(!1),k=F(),y=n.reduce((t,i)=>{const c=`${i.question}-${i._id}`;return t[c]=i.type==="Multiple choices"?[]:"",t},{}),b=(t,i)=>{const c=`${t.question}-${t._id}`;switch(t.type){case"Text":return e.jsx(T,{name:c,placeholder:"Text",value:i[c]||""});case"Single choice":return t.answers.map((o,S)=>e.jsxs("div",{children:[e.jsx(T,{type:"radio",name:c,value:o,checked:i[c]===o}),o]},S));case"Multiple choices":return t.answers.map((o,S)=>{var C;return e.jsxs("div",{children:[e.jsx(T,{type:"checkbox",name:c,value:o,checked:((C=i[c])==null?void 0:C.includes(o))||!1}),o]},S)});default:return null}};return e.jsx(I,{initialValues:y,onSubmit:t=>{Object.keys(t).some(o=>t[o]===""||Array.isArray(t[o])&&t[o].length===0)?x(!0):(localStorage.setItem("quizId",JSON.stringify(g)),localStorage.setItem("preview-take-quiz",JSON.stringify(t)),localStorage.setItem("take-quiz-duration",JSON.stringify(f)),k("/preview-take-quiz"))},children:({values:t})=>e.jsxs(M,{children:[e.jsxs(O,{children:[e.jsxs("h4",{children:[d+1,". ",s.question]}),b(s,t),j&&e.jsx(A,{children:"One or more fields are empty!"})]}),e.jsxs(w,{children:[e.jsxs("div",{children:[e.jsx(v,{type:"button",onClick:()=>{h(),x(!1)},disabled:m,children:"Back"}),e.jsx(v,{type:"button",onClick:p,disabled:r,children:"Next"})]}),u&&e.jsx(v,{type:"submit",children:"Submit"})]})]})})},J=n=>{if(n<60)return`${n} seconds`;if(n<3600){const u=Math.floor(n/60),d=n%60;return`${u} minutes ${d} seconds`}const s=Math.floor(n/3600),m=Math.floor(n%3600/60),r=n%60;return`${s} hours ${m} minutes ${r} seconds`},P=a.h3`
  margin-bottom: 10px;
`,V=a.div`
  margin-bottom: 50px;
`,_=a.div`
