...
`,F=({quiz:t,quizDelete:e})=>{const[n,r]=x.useState(!1),o=y(),c=s=>{o(`/create-take-quiz/${s}`)},d=s=>{o(`/update-quiz/${s}`)},u=s=>{e(s),r(v=>!v)};return i.jsxs(T,{children:[i.jsxs("div",{children:[i.jsx(W,{children:t.name}),i.jsx(B,{children:t.description})]}),i.jsxs("div",{children:[i.jsxs(V,{children:["Questions: ",t.questionsCount]}),i.jsxs(M,{children:["Number of submissions: ",t.count]})]}),i.jsx($,{onClick:()=>r(s=>!s),children:i.jsx(L,{})}),n&&i.jsxs(A,{children:[i.jsx(m,{onClick:()=>c(t._id),children:"Run"}),i.jsx(m,{onClick:()=>d(t._id),children:"Edit"}),i.jsx(m,{onClick:()=>u(t._id),children:"Delete"})]})]})},G=a.ul`
  display: flex;
